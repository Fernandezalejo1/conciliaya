  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Por Conciliar (Banco)</span>
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-slate-500 mt-1 flex items-center">
              <span className="font-semibold text-amber-600 mr-1">{totalBankPendingCount} movimientos</span>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Cartera Pendiente (Facturas)</span>
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-slate-500 mt-1 flex items-center">
              <span className="font-semibold text-blue-600 mr-1">{pendingInvoicesCount} facturas</span>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Efectividad del Cruce</span>
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-slate-500 mt-1 flex items-center">
              <span className="font-semibold text-emerald-600 mr-1">{autoMatches.length + suggestedMatches.length} sugerencias</span>
              con 0 errores
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Saldos a Favor / Créditos</span>
          ...
          <div className="mt-3">
            ...
            <p className="text-xs text-slate-500 mt-1 flex items-center">
              <span className="font-semibold text-purple-600 mr-1">{learnedAliases.length} alias</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-slate-900 text-base">Top Clientes con Saldo Deudor</h3>
              <p className="text-xs text-slate-500">Cuentas corrientes con mayor saldo pendiente de cobro</p>
            </div>
            <button
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-slate-900 text-base">Estado del Extracto Actual</h3>
            <p className="text-xs text-slate-500">Distribución de los movimientos bancarios</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <button
          onClick={() => setActiveTab('reconciliation')}
          className="group bg-white p-5 rounded-2xl border border-slate-200/80 hover:border-blue-400 hover:shadow-md transition-all text-left flex items-start space-x-4"
        >
          ...
          <div>
            <h4 className="font-semibold text-slate-900 text-sm group-hover:text-blue-600 transition-colors">Bandeja de Conciliación</h4>
            <p className="text-xs text-slate-500 mt-1">Revisa sugerencias inteligentes y asigna pagos dudosos en segundos.</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            <h4 className="font-semibold text-slate-900 text-sm group-hover:text-indigo-600 transition-colors">Carga de Archivos</h4>
            <p className="text-xs text-slate-500 mt-1">Sube el listado de facturas y el extracto bancario en Excel o CSV.</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            <h4 className="font-semibold text-slate-900 text-sm group-hover:text-emerald-600 transition-colors">Cuentas Corrientes</h4>
            <p className="text-xs text-slate-500 mt-1">Consulta estados de cuenta por cliente, saldos y créditos a favor.</p>
          </div>
        </button>
      </div>
    </div>
